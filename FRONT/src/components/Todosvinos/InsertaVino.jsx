...
const InsertaVino = () => {
    ...
    const onSubmit = (FormData) => {
        ...
        API.post("vinos", FormData).then((Response) => {
            navigate("/vinos");
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <label htmlFor='tipo'>Tipo de Vino</label>
        ...
        <input type="text" id="uva" {...register("uva", { required: true })} />
        ...
        <label htmlFor='añada'>Añada</label>
        <input type="number" id="añada" {...register("añada", { required: true })} />

        <label htmlFor='foto'>imagen</label>
        <input type="text" id="foto" {...register("foto", { required: true })} />

        <button type="submit">Inserta tu Vino</button>
