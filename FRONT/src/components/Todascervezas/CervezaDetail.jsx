      ...
      {cerveza ? (
        <>
          ...
          <div className="secundario">
            <p>
              <strong>tipo:</strong> {cerveza.tipo}
            </p>
            <p>
           
              <strong>color:</strong> {cerveza.color}
            </p>
            <p>
        
              <strong>descripcion:</strong> {cerveza.descripcion}
            </p>
            <p>
     
              <strong>graduacion:</strong> {cerveza.graduacion} º
            </p>
            <p>
